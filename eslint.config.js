 ...
 *
 * One more (class-methods-use-this) is switched off for seven rules
 * whose bodies are deliberately constant: src/rules/empty.js, src/rules/line-length.js, src/rules/grouped.js, src/rules/short-sections.js, src/rules/name-format.js and src/rules/name-matches-dir.js
