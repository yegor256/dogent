 ...
 * cannot usefully measure; everywhere else they stay on. One more
 * (max-lines-per-function) is switched off for src/rules/index.js,
 * whose single growing pipeline array exceeds the cap by design.
 *
